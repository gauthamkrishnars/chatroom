...
export default function LegalModal({ type, isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-xs animate-in fade-in duration-150">
      <div
        className="relative flex max-h-[85vh] w-full max-w-2xl flex-col rounded-2xl border border-slate-200 bg-white shadow-xl ring-1 ring-black/5"
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 text-xs leading-relaxed text-slate-600 space-y-5">
          {isTerms ? (
            <>
              <section>
                <h3 className="text-sm font-bold text-slate-900 mb-1.5">1. Acceptance of Terms</h3>
                <p>
              ...
              <section>
                <h3 className="text-sm font-bold text-slate-900 mb-1.5">2. User Accounts and Authentication</h3>
                <p>
              ...
              <section>
                <h3 className="text-sm font-bold text-slate-900 mb-1.5">3. Acceptable Community Conduct</h3>
                <p>
                ...
                <ul className="mt-2 list-disc list-inside space-y-1 text-slate-500 pl-2">
              ...
              <section>
                <h3 className="text-sm font-bold text-slate-900 mb-1.5">4. Content Ownership and License</h3>
                <p>
              ...
              <section>
                <h3 className="text-sm font-bold text-slate-900 mb-1.5">5. Disclaimer and Limitation of Liability</h3>
                <p>
            ...
            <>
              <section>
                <h3 className="text-sm font-bold text-slate-900 mb-1.5">1. Information We Collect</h3>
                <p>
              ...
              <section>
                <h3 className="text-sm font-bold text-slate-900 mb-1.5">2. How We Use Your Data</h3>
                <p>
              ...
              <section>
                <h3 className="text-sm font-bold text-slate-900 mb-1.5">3. Third Party Cloud Infrastructure</h3>
                <p>
              ...
              <section>
                <h3 className="text-sm font-bold text-slate-900 mb-1.5">4. Data Retention and Deletion</h3>
                <p>
              ...
              <section>
                <h3 className="text-sm font-bold text-slate-900 mb-1.5">5. Contact and Privacy Inquiries</h3>
                <p>
                  If you have questions regarding this Privacy Policy or your personal records, contact our privacy team directly at <span className="text-indigo-600 font-mono">privacy@pulsechat.app</span>.
                </p>
              </section>
            </>
          )}
        ...
        <div className="flex items-center justify-between border-t border-slate-200 p-4 bg-slate-50">
          <span className="text-[11px] text-slate-400 font-mono">Document v2.4</span>
          <button
            type="button"
            onClick={onClose}
